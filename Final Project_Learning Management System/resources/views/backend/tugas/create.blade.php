...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Tambah Tugas Ke Mahasiswa</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('tugas.index') }}" class="bg-gray-700 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('classes.store') }}" method="POST" class="w-full max-w-xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="class_numeric" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="date" value="{{ old('class_numeric') }}">
                        @error('class_numeric')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="relative">
                            <select name="teacher_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                ...
                                {{-- @foreach ($teachers as $teacher) --}}
                                    ...
                                    <option value="1">baco</option>
                                    <option value="1">bece</option>
                                    {{-- @endforeach --}}
                                </select>
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                       <textarea class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" name="" id="" cols="30" rows="5"></textarea>
