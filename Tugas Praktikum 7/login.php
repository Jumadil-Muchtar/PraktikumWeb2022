...
<body class="text-center">
    <main class="form-signin w-100 m-auto">
        <form method="POST">
            ...
            <!-- <p>Belum terdaftar? Login menggunakan akun admin untuk membuat akun!</p> -->
            <p>Belum terdaftar? <a data-bs-toggle="modal" data-bs-target="#modaldaftar">Daftar di sini!</a></p>
        </form>
    </main>
...
<div class="modal fade" id="modal_login_daftar" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Buat Akun</h5>
            ...
            <form method="post">
                ...
                <div class="modal-footer">
                    <button class="w-100 btn btn-lg btn-primary" type="submit" name="verifdaftar">Lanjut</button>
                </div>
            </form>
        </div>
    </div>
