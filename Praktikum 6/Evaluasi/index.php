...
if ($op == 'edit') {
    ...
    $jalan = $conn->query($sql);
    $array = mysqli_fetch_array($jalan);
    $NIM        = $array['NIM'];
    $Nama       = $array['Nama'];
    $Alamat     = $array['Alamat'];
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="Fakultas" id="Fakultas">
                                ...
                                <option value="Mobile Legends" <?php if ($Fakultas == "Mobile Legends") echo "selected" ?>>Mobile Legends</option>
