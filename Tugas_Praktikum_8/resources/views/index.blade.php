...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <div class="container-fluid">
            <span class="navbar-brand">Tugas Praktikum 8</span>
            <small>
                <b>
    ...
    <div class="heading">
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                <a class="navbar-brand">Data Mahasiswa Universitas AZ</a>
        ...
        <br><br>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahDataMahasiswa">
            + Tambah Mahasiswa
        </button>
    </div>
