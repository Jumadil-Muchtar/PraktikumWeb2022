...
<body>
  ...
  <form method="post" action="index.php">
    <div class="mb-3 w-25 mx-auto">
      ...
      <input type="name" class="form-control" id="name1" name="nama" aria-describedby="nameHelp">
      <div id="nametext" class="form-text">Please enter your name </div>
    </div>

    <div class="mb-3 w-25 mx-auto">
      <label for="class1" class="form-label">Class</label>
      <input type="class" class="form-control" id="class1" name="kelas" aria-describedby="classHelp">
      <div id="classtext" class="form-text">Please enter your class </div>
    </div>

    <div class="mb-3 w-25 mx-auto">
      <label for="address1" class="form-label">Address</label>
      <input type="address" class="form-control" id="address1" name="alamat" aria-describedby="addressHelp">
      <div id="addresstext" class="form-text">Please enter your address </div>
    </div>

    <select class="form-select mx-auto w-25" name="status" aria-label="Default select example" aria-placeholder="Status">
