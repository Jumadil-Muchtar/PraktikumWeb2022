        ...
        <div class="card bg-dark mb-5 mt-5" style="width: 55rem;">
            ...
            <form action="<?php echo e(route('sellers.update', $seller->id)); ?>" method ="post">
                ...
                <div class="form-group row pt-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id='name' value='<?php echo e($seller->name); ?>'>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="address" class="col-sm-2 col-form-label text-white">Address</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="address" id='address' value='<?php echo e($seller->address); ?>'>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="no_hp" class="col-sm-2 col-form-label text-white">No Hp</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="no_hp" id='no_hp' value='<?php echo e($seller->no_hp); ?>'>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="status" class="col-sm-2 col-form-label text-white">Status</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="status" id='status' value='<?php echo e($seller->status); ?>'>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vendor-app\resources\views/sellers/edit.blade.php ENDPATH**/ ?>