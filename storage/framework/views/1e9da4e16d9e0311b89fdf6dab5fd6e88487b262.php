...
<?php endif; ?>
    ...
    <div class="row pt-5 justify-content-center">
        <div class="card bg-dark mt-5 mb-5" style="width: 55rem;">
            ...
            <form action="<?php echo e(route('seller-permissions.store')); ?>" method ="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vendor-app\resources\views/seller_permissions/create.blade.php ENDPATH**/ ?>