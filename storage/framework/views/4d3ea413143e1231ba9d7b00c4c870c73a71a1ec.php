        ...
        <div class="card bg-dark mb-5 mt-5" style="width: 55rem;">
            ...
            <form action="<?php echo e(route('permissions.update', $permission->id)); ?>" method ="post">
                ...
                <div class="form-group row pt-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" id='name' value='<?php echo e($permission->name); ?>'>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="description" class="col-sm-2 col-form-label text-white">Description</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="description" id='description' value='<?php echo e($permission->description); ?>'>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="status" class="col-sm-2 col-form-label text-white">Status</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="status" id='status' value='<?php echo e($permission->status); ?>'>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vendor-app\resources\views/permissions/edit.blade.php ENDPATH**/ ?>