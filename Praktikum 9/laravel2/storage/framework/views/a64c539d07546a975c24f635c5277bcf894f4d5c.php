        ...
        <div class="card bg-dark mt-5 mb-5" style="width: 55rem;">
            ...
            <form action="<?php echo e(route('products.store')); ?>" method ="post">
                ...
                <div class="form-group row pt-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min='1' placeholder="RP" class="form-control" name="price" id='price'>
                    </div>
                </div>
                <div class="form-group row pt-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel2\resources\views/products/create.blade.php ENDPATH**/ ?>